...
#for i in range(len(alt_data)):
    ...
    p_day='/group_workspaces/jasmin2/asci/eeara/model_runs/u-by352/All_months/' #new run
    p_ind='/group_workspaces/jasmin2/asci/eeara/model_runs/u-by092/All_months/' #baseline run 
    if i%3==0 and i<49:
