...
#for i in range(len(alt_data)):
    print('\n File STARTED ')
    #if i==0:
    #p_day='/group_workspaces/jasmin2/asci/eeara/model_runs/u-bz457/All_months/' #PD + biogenic
    #p_ind='/group_workspaces/jasmin2/asci/eeara/model_runs/u-bz052/All_months/' #PD baseline sim
    
    p_day='/group_workspaces/jasmin2/asci/eeara/model_runs/u-bz049/All_months/' #Present day
    p_ind='/group_workspaces/jasmin2/asci/eeara/model_runs/u-bz052/All_months/' #Preindistrial
    #p_day='/group_workspaces/jasmin2/asci/eeara/model_runs/u-by412/All_months/' #Present day
    #p_ind='/group_workspaces/jasmin2/asci/eeara/model_runs/u-by092/All_months/' #Preindistrial
    p_day='/group_workspaces/jasmin2/asci/eeara/model_runs/u-ca123/All_months/' #sulphurless+pure biogenic
    p_ind='/group_workspaces/jasmin2/asci/eeara/model_runs/u-ca124/All_months/' #sulphurless planet
    if i%3==0 and i<49:
        ...
        di_eff = di_eff*-1
        in_eff = in_eff*-1
        dir_title = 'Direct effect (W/m2) - (PD)-(PInd)'
        ind_title = 'Indirect effect (W/m2) - (PD)-(PInd)'
        i#dir_title = 'Direct effect (W/m2) '
