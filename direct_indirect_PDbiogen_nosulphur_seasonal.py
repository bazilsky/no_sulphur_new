...
#for i in range(len(alt_data)):
    print('\n File STARTED ')
    #if i==0:
    #p_day='/group_workspaces/jasmin2/asci/eeara/model_runs/u-bz155/All_months/' #PD + biogenic
    p_day='/group_workspaces/jasmin2/asci/eeara/model_runs/u-bz291/All_months/' #PD + biogenic
    p_ind='/group_workspaces/jasmin2/asci/eeara/model_runs/u-bz050/All_months/' #PD baseline sim
    if i%3==0 and i<49:
        ...
        for j in range(len(net_sw.coord('time').points)): 
            print('j NUMBER =',j)
            di_eff_2 = cube1-cube3
            di_eff = net_sw[j,:,:]
            in_eff = cloud_sw[j,:,:]
