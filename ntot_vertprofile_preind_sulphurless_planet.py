...
mpath2='/group_workspaces/jasmin2/asci/eeara/model_runs/u-bz052/All_months/' # baseline simulation preindustrial
 ...
 #       diff=((new1-old1)/old1)*100
      #  data, lat, lon = file_save(new1,i,alt_data[i])
       ...
       # ticks=[1e0,5e0,1e1,2e1,5e1,1e2,2e2,5e2,1e3,2e3,5e3,1e4,3e4,6e4,1e5]
        ...
        plt.title('Change in Particle number concentration (cm'+u'\u207B\u00B3'+') : PREIND' )
