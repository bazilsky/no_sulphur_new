...
#for i in range(len(alt_data)):
    ...
    p_day='/group_workspaces/jasmin2/asci/eeara/model_runs/u-ca179/All_months/' #sulphurless 
    p_ind='/group_workspaces/jasmin2/asci/eeara/model_runs/u-ca123/All_months/' #baseline present day
    p_day='/group_workspaces/jasmin2/asci/eeara/model_runs/u-ca440/All_months/' #sulphurless 
    p_ind='/group_workspaces/jasmin2/asci/eeara/model_runs/u-ca439/All_months/' #baseline present day
    if i%3==0 and i<49:
