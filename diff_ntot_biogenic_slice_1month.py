...
#for i in range(len(alt_data)):
    ...
    p_day1='/group_workspaces/jasmin2/asci/eeara/model_runs/u-by921/2017jan/' # this is the baseline
    p_day2='/group_workspaces/jasmin2/asci/eeara/model_runs/u-by920/2017jan/' # new run  

    p_day1='/gws/nopw/j04/asci/eeara/model_runs/u-ca439/2017jan/' # this is the baseline
    p_day2='/gws/nopw/j04/asci/eeara/model_runs/u-ca976/2017jan/' # new run  
    ...
    if i%3==0 and i<49:
        ...
        plot_diff(c,temp_str,-20000,20001,2000) # for 11km
        #plot_diff(c,temp_str,-1500,1501,300) # for 11km
        print ('max = ', np.max(c)) 
        print ('min = ', np.min(c))
