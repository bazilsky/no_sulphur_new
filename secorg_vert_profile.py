...
#for i in range(len(alt_data)):
    ...
    if i%3==0:
        ...
        #cond_sink_path = '/group_workspaces/jasmin2/asci/eeara/model_runs/u-bz049/All_months/'+'All_months_m01s34i092_secorg_mass_mixing_ratio.nc'
        cond_sink_path = '/group_workspaces/jasmin2/asci/eeara/model_runs/u-bz871/All_months/'+'All_months_m01s34i092_secorg_mass_mixing_ratio.nc'
        filepath = '/group_workspaces/jasmin2/asci/eeara/model_runs/u-bs405/All_months/'
        ...
        print(new1)
        new1 = new1*(29.0/404.0)*1.0e5/1.0e-12 # converting mass fraction to pptv of HOM C10
       ...
       #ticks5_label = ['1e-6','5e-6','1e-5','5e-5','1e-4','5e-4','1e-3','5e-3','1e-2']
        ticks5_label = [str(o)+'x 1e-5' for o in ticks5]
        ...
        plt.contourf(x,y,data,ticks5,norm=colors.LogNorm(vmin=1e-2,vmax=5e3),cmap=ruths_colors_r('roma'),resolution='c', format = '%.0e')
        ...
        print("\nThe mean value is      = ", np.mean(data))
        ...
        plt.title('Secorg mixing ratio(pptv) - sulphurless + biogenic')
