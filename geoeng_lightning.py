...
#for i in range(len(alt_data)):
    ...
    #p_day2='/group_workspaces/jasmin2/asci/eeara/model_runs/u-bz050/All_months/'  # no sulphut model run
    ...
    if i%3==0 and i<49:
        ...
        temp_str='Percentage change in Lightning strikes per year ' # note the superscript is done 
