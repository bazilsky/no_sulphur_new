...
def plot_diff(slice1,title,lim1,lim2,step):
    ...
    #plt.figure(figsize=(12,6),dpi = 300)# this works 
...
def get_model_data(mpath,data_level):
    ...
    #ccn_file = 'All_months_m01s38i476_CLOUD_LIQUID_FRACTION_______________.nc'
    ccn_file = 'All_months_m01s00i004_THETA_AFTER_TIMESTEP________________.nc'
...
#for i in range(len(alt_data)):
    ...
    if i%3==0 and i<49:
        ...
        plt.savefig('no_sulphur_potemp_new.eps',dpi = 500)
