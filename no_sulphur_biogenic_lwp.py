...
asci_path = '/gws/nopw/j04/asci/eeara/'
...
mpath1=asci_path+'model_runs/u-cb602/' # sulphurless planet
mpath2=asci_path+'model_runs/u-ca440/' # baseline simulation
...
#for i in range(len(alt_data)):
    ...
    if i%3==0:
        ...
        pltfunc.plot_diff_4(qcl1,diff,'Percent change in LWP(sulphurless_biogen)-(sulphurless)',-50,50,'RdYlBu_r') 
        plt.show()
