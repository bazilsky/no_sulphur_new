...
#..............basemap requires lat and lon to be in increasing order
   ...
   # ticks6_label = ['-1e-22','1e-30','1e-16']
    ...
    x=plt.contourf(new_lon_final,lat,data_final,vmin=lim1,vmax=lim2,transform=ccrs.PlateCarree(),cmap='RdYlBu_r',levels=ticks6)
