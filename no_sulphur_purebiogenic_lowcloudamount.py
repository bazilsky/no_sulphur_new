...
#..............basemap requires lat and lon to be in increasing order
   ...
   # ticks6_label = ['-1e-22','1e-30','1e-16']
    ...
    x=plt.contourf(new_lon_final,lat,data_final,vmin=lim1,vmax=lim2,transform=ccrs.PlateCarree(),cmap=ruths_colors('vik'),levels=ticks6)
...
def get_model_data(mpath,data_level):
    ...
    ccn_file = 'All_months_m01s09i203_LOW_CLOUD_AMOUNT____________________.nc'
...
#for i in range(len(alt_data)):
    ...
    p_day1='/group_workspaces/jasmin2/asci/eeara/model_runs/u-ca179/All_months/'  # baseline model run
    p_day2='/group_workspaces/jasmin2/asci/eeara/model_runs/u-ca206/All_months/'  # new model run
    if i%3==0 and i<49:
