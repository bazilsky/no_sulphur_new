...
#..............basemap requires lat and lon to be in increasing order
   ...
   # ticks6_label = ['-1e-22','1e-30','1e-16']
    ...
    x=plt.contourf(new_lon_final,lat,data_final,vmin=-100,vmax=100,transform=ccrs.PlateCarree(),cmap=ruths_colors('vik'),levels=ticks6)
...
#for i in range(len(alt_data)):
    ...
    if i%3==0 and i<49:
        ...
        temp_str='Percentage change in CDNC at 1km - present day'
