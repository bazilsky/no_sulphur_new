...
mpath1='/group_workspaces/jasmin2/asci/eeara/model_runs/u-ca206/' # sulphurless planet
mpath2='/group_workspaces/jasmin2/asci/eeara/model_runs/u-ca179/' # baseline simulation
...
#for i in range(len(alt_data)):
    ...
    if i%3==0:
        ...
        pltfunc.plot_diff_4(qcl1,diff,'percentage change in liquid water path',-60,61,'RdYlBu_r') 
        plt.show()
