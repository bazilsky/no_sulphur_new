...
#for i in range(len(alt_data)):
    ...
    p_day1='/group_workspaces/jasmin2/asci/eeara/model_runs/u-by412/L1/'  # baseline model run
    p_day2='/group_workspaces/jasmin2/asci/eeara/model_runs/u-by114/L1/'  # new model run
    ...
    if i%3==0 and i<49:
        ...
        print('the mean is    = ', np.mean(c.data))
        temp_str='Percentage change in CCN '
