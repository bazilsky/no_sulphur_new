...
mpath1='/group_workspaces/jasmin2/asci/eeara/model_runs/u-bz055/All_months/' # sulphurless planet
mpath2='/group_workspaces/jasmin2/asci/eeara/model_runs/u-bz052/All_months/' # baseline simulation
...
#for i in range(len(alt_data)):
    ...
    cn_file = 'All_months_m01s00i266_cloud_volume_fraction_in_atmosphere_layer.nc'
 ...
 #       diff=((new1-old1)/old1)*100
      #  data, lat, lon = file_save(new1,i,alt_data[i])
       ...
       # ticks=[1e0,5e0,1e1,2e1,5e1,1e2,2e2,5e2,1e3,2e3,5e3,1e4,3e4,6e4,1e5]
        ...
        #plt.contourf(x,y,data,ticks5,norm=colors.SymLogNorm(linthresh = 1e1,linscale = 1e0,vmin=-1e5,vmax=1e1),cmap='RdYlBu_r', format = '%.0e')
        ...
        plt.title('Percentage change in cloud fraction (cm'+u'\u207B\u00B3'+') - PIND' )
