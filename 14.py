...
#for i in range(len(alt_data)):
   ...
   # p_day2='/group_workspaces/jasmin2/asci/eeara/model_runs/u-by920/All_months/' # new run  
    ...
    p_day1='/group_workspaces/jasmin2/asci/eeara/model_runs/u-bz050/All_months/' # this is the baseline
    p_day2='/group_workspaces/jasmin2/asci/eeara/model_runs/u-bz693/All_months/' # new run  
    if i%3==0 and i<49:
        ...
        temp_str='Change in Ntot at surface (cm'+u'\u207B\u00B3'+')'
        ...
        plot_diff(c,temp_str,-3000,3001,500) # for 11km
        print ('max = ', np.max(c)) 
        print ('min = ', np.min(c))
