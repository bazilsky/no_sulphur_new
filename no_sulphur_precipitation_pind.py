...
#for i in range(len(alt_data)):
    ...
    p_day1='/group_workspaces/jasmin2/asci/eeara/model_runs/u-by092/All_months/'  # baseline model run
    p_day2='/group_workspaces/jasmin2/asci/eeara/model_runs/u-by352/All_months/'  # new model run
    ...
    if i%3==0 and i<49:
        ...
        temp_str='Percentage change in precipitation - preindustrial'
