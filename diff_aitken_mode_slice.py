...
#..............basemap requires lat and lon to be in increasing order
    ...
    ticks5 = [1e0,5e0,1e1,5e1,1e2,5e2,1e3,5e3,1e4,5e4,1e5]
    ...
    cbar=plt.colorbar(x,ax=ax,ticks=ticks5)
    
    #cbar.ax.tick_params(labelsize=16)
    cbar.ax.set_yticklabels(ticks6)
    cbar.ax.tick_params(labelsize=16)
...
#for i in range(len(alt_data)):
    ...
    if i%3==0 and i<49:
        ...
        temp_str='Percentage change in aitken-sol mode at 1km'
